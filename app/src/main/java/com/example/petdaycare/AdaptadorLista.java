...
public class AdaptadorLista extends ArrayAdapter<Animal> {
    public AdaptadorLista(@NonNull Context context, int resource, @NonNull ArrayList<Animal> words) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        nombre.setText(currentWord.nombre_animal);

        TextView raza=(TextView)lista_animal.findViewById(R.id.raza);
        raza.setText(currentWord.raza_animal);
        return lista_animal;
    }
}
